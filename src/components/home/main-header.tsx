...
export function MainHeader({
  ...
  return (
    <header
      className={cn(
        'hover-animation z-10 w-full bg-main-background/60 px-4 py-2 backdrop-blur-md',
    ...
    >
      ...
      <div className='flex flex-col min-w-0'>
        ...
        {subtitle && <p className="truncate text-sm text-light-secondary dark:text-dark-secondary">{subtitle}</p>}
      </div>
